...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Expert truck & trailer maintenance and repair in Atlanta, GA. Fast turnaround for fleets and independents. We fix it. We get you back on the road." },
